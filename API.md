...
* [Описание методов API](#описание-методов-api)
  ...
  * [Метод login](#метод-login)
    ...
    * [Ошибки](#ошибки-1)
  * [Метод autoLogin](#метод-autologin)
  ...
  * [Метод getMessages](#метод-getmessages)
    * [Описание метода](#описание-метода-9)
    * [Адрес](#адрес-9)
...
* [Метод Shoot](#метод-shoot)
  ...
  * [Метод getScene](#метод-getscene)
    * [Описание](#описание-4)
    * [Адрес](#адрес-15)
    * [Параметры](#параметры-15)
    * [Успешный ответ:](#успешный-ответ-9)
    * [Ошибки](#ошибки-15)
  * [Метод setPlayer](#метод-setplayer)
    * [Описание](#описание-5)
    * [Адрес](#адрес-16)
    * [Параметры](#параметры-16)
    * [Успешный ответ:](#успешный-ответ-10)
    * [Ошибки](#ошибки-16)
<!-- TOC -->
...
| token    | string | md5(md5(login+password)+rnd)          |
...
### Описание
Ходит в базу данных и возвращает информацию о всех выстрелах.
С их положением и направлением выстрела.
