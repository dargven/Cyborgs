...
* [Описание методов API](#описание-методов-api)
  ...
  * [Метод getMessage](#метод-getmessage)
    ...
    * [Ошибки](#ошибки-8)
  * [Метод getPlayers](#метод-getplayers)
    * [Описание](#описание)
    * [Адрес](#адрес-9)
...
При успешной авторизации пользователя ему возвращается список сообщений
...
| Параметры | Тип | Комментарий                     |
|-----------|-----|---------------------------------|
| token     | str | Аутентификационный токен        |
| x         | int | Позиция по x                    |
| y         | int | Позиция по y                    |
| vx        | int | Позиция по vx(направление по x) |
| vy        | int | Позиция по vy(направление по x) |
